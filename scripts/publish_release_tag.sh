...
# highest existing vX.Y.Z tag (+1 patch) or setup.py RELEASE_VERSION when no tags exist.
...
Requires TESTPYPI_API_TOKEN (PyDevices org secret with access to this repo).
EOF
}
